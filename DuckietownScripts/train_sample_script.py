...
def get_duckietown_dicts(root_dir):
    ...
    for name in data.keys():
        ...
        for annotation in data[name]:
            ob_list = []
            obj_ann = {
                "bbox": [annotation['bbox'][0], annotation['bbox'][1], annotation['bbox'][0] + annotation['bbox'][2],
...
root_dir = "/home/ranais/Ranai/Research/object-detection-ex-template/Training"
...
cfg = get_cfg()
cfg.merge_from_file("Base-RCNN-FPN.yaml")
cfg.DATASETS.TRAIN = ("/home/ranais/Ranai/Research/object-detection-ex-template/Training/frames-20220412T154427Z-001/frames",)
